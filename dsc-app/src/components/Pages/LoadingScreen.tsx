  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-r from-indigo-500 to-purple-600">
      <div className="mb-8 flex items-center space-x-4">
        ...
        <h1 className="text-4xl font-bold text-white">Loading DSC App</h1>
      </div>
      <div className="w-64 rounded-full bg-slate-400">
        <div
          className="rounded-full bg-white p-0.5 text-center text-xs leading-none font-medium text-slate-500 transition-all duration-300 ease-in-out"
